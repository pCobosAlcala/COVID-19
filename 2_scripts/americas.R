  ...
  americas %>% 
    ...
    geom_text_repel(aes(x = days,
                        y = cases,
                        label = country),
                    data = otros2, size = 2.5, color = "grey55") +
    geom_point(aes(days,
                   cases,
                   group = country),
               data = otros,
    ...
    labs(title = "Casos reportados acumulados de COVID-19 en las Américas - 27/mar/2020",
         ...
         caption = "@pCobosAlcala\n\nNota 1: las líneas grises son del resto de países del mundo hasta en sus primeros 15 días con más de 100 casos\nNota 2: no incluyo ni a Estados Unidos ni a China\nFuente: base de JHE CSSE con datos de la OMS (https://bit.ly/39lu0hq)",
